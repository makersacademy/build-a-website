...
Your program should now be running and sending output to the command line.  In order to see you application running, you'll nned to open a browser and navigate to `http://localhost:4567`. Pretty neat right?
